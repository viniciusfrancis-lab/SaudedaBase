...
with st.spinner("Carregando dados..."):
    ...
    resumo["alerta"] = resumo["alerta"].replace({
    "CPF inválido/em branco": "Alunos sem CPF",
    "Matrícula duplicada": "Matriculas Duplicadas",
...
try:
    ...
    df_raw["col_2"] = df_raw["col_2"].replace({
    "CPF inválido/em branco": "Alunos sem CPF",
    "Matrícula duplicada": "Matriculas Duplicadas",
    "Deficiência sem descrição": "Flag Deficiência sem Descrição",
    "Descrição de deficiência indevida": "Descrição de Deficiência Inconsistente",
...
if resultados.empty:
    ...
    tipos = ["Todos"] + sorted(resultados["alerta"].unique())
    filtro = st.selectbox("Filtrar por tipo de alerta:", tipos)

    
    filtro["col_2"] = filtro["col_2"].replace({
    "CPF inválido/em branco": "Alunos sem CPF",
    "Matrícula duplicada": "Matriculas Duplicadas",
    "Deficiência sem descrição": "Flag Deficiência sem Descrição",
    "Descrição de deficiência indevida": "Descrição de Deficiência Inconsistente",
    ...
    nome_arquivo = f"alertas_{filtro.replace(' ', '_').replace('/', '_')}.csv"
